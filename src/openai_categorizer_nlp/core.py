...
def parse_one(
    ...
    *,
    ...
    text : str
    categories : Sequence[str]
        Allowed categories (required if classification enabled).
    include_entities : bool
    include_classification : bool
    single_label : bool
        If True, exactly one category is returned.
    model : str
        OpenAI snapshot to use.
    system_prompt : str | None
        Custom system prompt; autogenerated if None.
    temperature : float
        Sampling temperature (0 = deterministic; 1 = creative).
    client_override : openai.OpenAI | None
        Custom client (e.g., for mocking).

    Returns
    -------
    dict
        Keys vary by enabled features.
    """
